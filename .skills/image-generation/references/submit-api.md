...
|-------|-------|
| Method | `POST` |
| URL | `https://app-a8tauoehdn9d-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-a8tauoehdn9d-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
