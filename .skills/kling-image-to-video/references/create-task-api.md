...
| Property | Value |
|----------|-------|
| **Endpoint** | `POST https://app-a8tauoehdn9d-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-a8tauoehdn9d-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
