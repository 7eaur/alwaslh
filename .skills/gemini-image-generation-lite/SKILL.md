...
| Item | Value |
|------|-------|
| Endpoint | `POST https://app-a8tauoehdn9d-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent` |
...
// POST to: https://app-a8tauoehdn9d-api-rLobRWZ712b9.gateway.appmedo.com/v1beta/models/gemini-3.1-flash-image-preview:generateContent
